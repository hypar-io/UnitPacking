...
namespace UnitPacking
{
    public class Function
    {
        ...
        private UrlModelStore<UnitPackingInputs> store;

        public async Task<UnitPackingOutputs> Handler(UnitPackingInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<UnitPackingInputs>();
            }
            

            var l = new InvocationWrapper<UnitPackingInputs,UnitPackingOutputs> (store, UnitPacking.Execute);
